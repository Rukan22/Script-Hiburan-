...
#Recoded By : M.r Rukan022
#Tool Unfaedah :v

clear
            
            cowsay -f ghostbusters “M.R RUKAN022” |
lolcat
toilet -f standard -F gay “M.R RUKAN022“
date | lolcat
            echo $mer"  Tool Unfaedah | M.r Rukan022 $st"

lagi=1
while [ $lagi -lt 6 ];
do
echo $cy"1. Sadap WA work ni banh :v ";
echo $pur"====================]" 
...
echo $pur"====================]" 
echo $cy"5. Santet Online";
echo $pur"====================]"        
echo $i"6. EXIT $st";
echo ""
echo    $mer"╭─Pilih Nomor Berapa Banh!!? $st " 
read -p "╰─•>  " pil; 
...
read lu
clear
echo "Sabar cok lagi nyadap ini $tr" | lolcat
echo ""
...
echo $pu " Dimas : Eh maen ml yok $cy[15:06]"
echo $i " Me : ayok $cy[15:06]"
echo $pu " Dimas : Oke dah, gua mau off, besok gua kerumah lu $cy[17:05]"
echo $i " Me : Ok... $cy[17:22]"
exit
;;
